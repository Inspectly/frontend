  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
        ...
        {/* Listings grid with fade-in animation */}
          ...
          {listings.map((listing, index) => (
            ...
            >
              ...
              <CardContent className="p-5">
                ...
                <Button variant="outline" size="sm" className="w-full text-sm h-9 group-hover:border-primary group-hover:text-primary group-hover:bg-primary/5 transition-all duration-300" onClick={() => navigate("/signup")}>
                  View Details
                </Button>
              </CardContent>
            </Card>
        ...
        >
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Or <button onClick={() => navigate("/signup")} className="text-primary hover:underline font-medium transition-colors">post your own project</button> to get started
          </p>
        </div>
      </div>
    </section>
