...
import { faAt, faUser, faShieldAlt, faCheckCircle } from "@fortawesome/free-solid-svg-icons";
...
const Login: React.FC = () => {
  ...
  const handleGoogleSignIn = async () => {
    // 1. Validation Logic Added (Requested)
    if (!agreeToTerms) {
      setError("You must agree to the terms.");
      return;
    }
        ...
        <div className="w-full max-w-[1400px] flex items-center justify-center lg:justify-start gap-16 2xl:gap-24 px-4">
          ...
          <div className={`${CARD_SIZE} bg-white rounded-3xl shadow-2xl p-10 relative z-20 flex flex-col shrink-0`}>
            ...
            <div className="flex-1 flex flex-col justify-center py-6">
                {error && !isBackendLoading && <div className="mb-4 p-3 rounded-lg bg-red-50 text-red-600 text-sm font-medium flex items-center justify-center gap-2 text-center">{error}</div>}
                ...
                <form onSubmit={handleSignIn} className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className={`flex px-4 py-1 bg-white rounded-lg border border-gray-300 focus-within:ring-2 ${GOLD_RING_FOCUS} ${GOLD_BORDER_FOCUS} transition-all duration-200`}>
                        <input
                        ...
                        required
                        />
                        <button type="button" onClick={togglePasswordVisibility} className="ml-4 text-gray-300 hover:text-gray-600 transition">
                  ...
                  <div className="flex items-center px-1">
                    <label className="inline-flex items-center text-xs text-gray-500 cursor-pointer select-none">
                        ...
                        />
                        <span className="ml-2">
                            I agree to <a href="#" className="underline hover:text-gray-800">Privacy Policy</a> and <a href="#" className="underline hover:text-gray-800">Terms of Use</a>
                        </span>
                    </label>
                  </div>
                ...
                <div className="relative mt-8 mb-6">
                    ...
                    <div className="relative flex justify-center"><span className="bg-white px-4 text-xs font-bold text-gray-400 uppercase tracking-wider">or continue with</span></div>
                </div>
                ...
                >
                    ...
                    <span className="text-gray-600 font-semibold group-hover:text-white transition-colors">Sign In with Google</span>
                </button>
            </div>
            ...
            <div className="mt-auto pt-4 text-center shrink-0">
              <p className="text-xs text-gray-400 font-medium">
                ...
                <button onClick={handleSignUp} className={`font-bold ${GOLD_TEXT} hover:text-black transition`}>Sign up now</button>
              </p>
            </div>
          </div>
