...
import { useGetReportsQuery, useCreateReportMutation } from "../features/api/reportsApi";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createReport({
        ...
        // TODO: replace with real S3 link when upload is implemented
      ...
      <div className="card h-full p-0 rounded-xl border-0 overflow-hidden">
        ...
        <div className="bg-white p-6">
          {currentReports.length === 0 ? (
            <div className="text-center text-gray-500">You have no current reports.</div>
          ) : (
            <div
            ...
            >
              {currentReports.map((report) => (
                <ReportCardWithStatus
                  ...
                  onRetry={() => {
                    // Optional: trigger a retry task if you support it
