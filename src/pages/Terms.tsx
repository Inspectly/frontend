...
const Terms = () => {
  ...
  const content = (
    <div className="pt-24 pb-6 px-6 lg:pt-28 lg:pb-8 lg:px-8 max-w-4xl mx-auto animate-fade-up">
      <div className="text-center mb-10 scroll-mt-24">
      ...
      <div className="space-y-3">
        {sections.map((section) => {
          ...
          return (
            <Card key={section.title} className="border-border rounded-xl shadow-sm">
              <CardContent className="p-4">
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <h2 className="font-semibold text-foreground text-sm mb-1.5">{section.title}</h2>
                    <p className="text-sm text-muted-foreground leading-[1.5]">{section.content}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
