...
const Payment: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:h-[calc(100vh_-_80px)]">
      {/* Left Panel */}
      <div className="bg-gradient-to-r from-gray-100/70 to-gray-100 -mt-24 w-full lg:w-1/3 lg:order-none order-1">
        <div className="flex justify-center items-center h-full min-h-full pt-32 px-14 pb-14 lg:px-14 lg:pt-32 lg:pb-8 text-center relative">
          <div>
            {selectedPlan ? (
      ...
      {/* Right Panel */}
      <div className="flex items-center pt-8 px-4 lg:py-0 lg:pr-0 h-full min-h-full lg:justify-start justify-center lg:pl-28 xl:pl-52 2xl:pl-64 w-full lg:w-2/3 order-2">
