 ...
 * auth, mirroring the web app. Fully non-blocking: any failure is swallowed so
 * it never prevents the user from entering the app (AuthGate handles the
 * actual authenticated state via onAuthStateChanged).
 */
