...
const FEATURES = [
  { icon: "briefcase-outline", label: "Find jobs in the marketplace" },
  { icon: "cash-outline", label: "Submit bids & get paid fast" },
  { icon: "calendar-outline", label: "Manage visits & schedule" },
] as const;
        ...
        <View className="flex-1 px-6 justify-between py-8">
          <View className="mt-8">
            <View className="flex-row items-center gap-2">
              ...
              <Text className="text-2xl font-extrabold text-white">Inspectly Pro</Text>
            </View>
            ...
            <Text className="text-gray-300 text-base mt-4 leading-relaxed">
              Browse jobs, send competitive bids, schedule visits, and track your
